...
**🚧 PENDING (tiếp tục phiên kế):**

### Phase 36 còn lại (1-2 ngày)
- 36.5 Rust `machine_id` lib (hostname + MAC + WindowsGUID hash, 16 hex)
- 36.6 Client heartbeat 5min + IP detection (ipify.org)
