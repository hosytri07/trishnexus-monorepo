...
>
> **Cập nhật:** 2026-04-28 (Phase 19.22, máy nhà sync xong từ cơ quan)
...
**Tình trạng cuối phiên cơ quan (28/04/2026):**
- Phase 19.20 + 19.21 + 19.22 đã commit + push GitHub. Chưa deploy Vercel.
- Máy nhà cần: test localhost → deploy → verify production.

**Pending cho phiên kế:**
1. ✅ Test localhost:3000 (5 chỗ — xem checklist dưới)
2. ⏳ `git push origin main` để Vercel auto-deploy
3. ⏳ Verify https://trishteam.io.vn/on-thi-chung-chi load nhanh không
4. ⏳ Nếu OK → bắt đầu Phase 20 (FCM push, admin CRUD, bookmark, lịch sử thi)
...
| **19.22** | Website: Polish (footer, 404, notification prefs, mobile dinh-muc fix) | 28/04 cơ quan |
| **20.x** | ⏳ FCM push, admin CRUD, bookmark, lịch sử thi, leaderboard, i18n | TODO |
