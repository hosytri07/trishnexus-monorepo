...
- **38.2 TrishLibrary PDF Pro** (4 module mới, ~5 ngày):
  - PDF Stamp Pro (image + QR + chữ ký scan)
  - PDF Binder theo danh mục Excel
  - PDF Title Reader OCR (auto rename file)
  - PDF Revision Compare (highlight diff)
