"""TrishSearch — entry point placeholder.
...
APP_NAME = "TrishSearch"
APP_VERSION = "v0.1.0"
APP_TAGLINE = "Tìm kiếm thông tin / file / note — local + cloud"
APP_LOGO = "🔎"
