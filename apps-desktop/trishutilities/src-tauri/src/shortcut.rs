...
#[tauri::command]
pub fn scan_desktop() -> Result<Vec<DesktopEntry>, String> {
...
#[tauri::command]
pub fn scan_start_menu() -> Result<Vec<DesktopEntry>, String> {
    let mut entries = Vec::new();
    // User Start Menu
...
#[tauri::command]
pub fn parse_lnk(lnk_path: String) -> Result<LnkParsed, String> {
...
#[tauri::command]
pub fn launch_shortcut(opts: LaunchOpts) -> Result<(), String> {
...
#[cfg(target_os = "windows")]
#[tauri::command]
pub async fn extract_icon_from_exe(
    app: tauri::AppHandle,
    exe_path: String,
