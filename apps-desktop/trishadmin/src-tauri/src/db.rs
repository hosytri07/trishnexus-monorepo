...
//! Path: %APPDATA%/vn.trishteam.admin/index.db (Windows) hoặc tương đương.
//! Phase 24.1 — TrishDrive merged vào TrishAdmin: DB path follow app_data_dir của
//! TrishAdmin (vn.trishteam.admin), không share với TrishDrive standalone.
