/**
 * LoginScreen — Phase 22.5.
 * Login Firebase + Remember me + Quên mật khẩu. Pattern y hệt TrishDrive User app.
 */
...
const REMEMBER_KEY = 'trishiso_remember_me';
      ...
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center gap-3 mb-6">
          <img
            src={logoUrl}
            alt="TrishISO"
            style={{ width: 100, height: 100, borderRadius: 22, objectFit: 'cover', boxShadow: 'var(--shadow-md)' }}
          />
          <div className="text-center">
            <h1 style={{ fontSize: 22, fontWeight: 600, color: 'var(--color-text-primary)' }}>TrishISO</h1>
            <p style={{ fontSize: 13, color: 'var(--color-text-muted)' }}>Quản lý hồ sơ ISO + thiết bị nội bộ</p>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <p style={{ fontSize: 13, color: 'var(--color-text-muted)' }}>
            {mode === 'signin'
              ? <>Login tài khoản TrishTEAM. Truy cập app yêu cầu role <b>admin</b> hoặc <b>iso_admin</b> được duyệt.</>
              : 'Tạo tài khoản TrishTEAM mới. Sau khi đăng ký, admin cấp quyền iso_admin để truy cập TrishISO.'}
          </p>
