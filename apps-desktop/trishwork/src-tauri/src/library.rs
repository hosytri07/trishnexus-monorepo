...
//!
//! Wave 44.3.B — gộp vào TrishWork. Một số helper (toggle_sticky_window,
//! parse_font_family...) chỉ dùng ở run() của app cũ nên giờ unused — allow
//! dead_code để build sạch, không xoá phòng khi cần lại.
...
pub fn default_store_location() -> Result<StoreLocation, String> {
...
#[tauri::command]
pub fn load_library(path: Option<String>) -> Result<LoadResult, String> {
...
#[tauri::command]
pub fn save_library(path: Option<String>, content: String) -> Result<SaveResult, String> {
    let p = resolve_store_path(path)?;
    ensure_parent(&p)?;
...
#[tauri::command]
pub fn save_qr_file(path: String, base64_data: String) -> Result<u64, String> {
...
pub fn read_text_string(path: String) -> Result<String, String> {
...
pub fn write_text_string(path: String, content: String) -> Result<(), String> {
    let p = PathBuf::from(&path);
    let bytes = content.as_bytes();
...
#[tauri::command]
pub fn attach_file(uid: String, src_path: String) -> Result<String, String> {
...
#[tauri::command]
pub fn remove_attached_file(path: String) -> Result<(), String> {
    let p = PathBuf::from(&path);
    if !p.exists() {
...
#[tauri::command]
pub fn read_image_exif(path: String) -> Result<ExifData, String> {
    let p = PathBuf::from(&path);
    if !p.is_file() {
        return Err(format!("Không phải file: {path}"));
    }
...
#[tauri::command]
pub async fn get_thumbnail(path: String, max_size: u32) -> Result<String, String> {
...
#[tauri::command]
pub fn list_image_files(folder: String, recursive: bool) -> Result<Vec<ImageFileEntry>, String> {
...
#[tauri::command]
pub fn pdf_merge(input_paths: Vec<String>, output_path: String) -> Result<u32, String> {
...
#[tauri::command]
pub fn pdf_split(input_path: String, output_dir: String) -> Result<u32, String> {
...
#[derive(serde::Serialize)]
pub struct PdfExtractImagesResult {
    extracted: u32,
    skipped: u32,
    output_dir: String,
}
...
#[tauri::command]
pub fn check_qpdf() -> Result<ToolStatus, String> {
...
#[tauri::command]
pub fn check_tessdata_best(lang_code: String) -> Result<bool, String> {
...
#[tauri::command]
pub async fn download_tessdata_best(lang_code: String) -> Result<String, String> {
    let dir = tessdata_best_dir()?;
    let file = dir.join(format!("{lang_code}.traineddata"));
...
#[tauri::command]
pub fn get_tessdata_best_dir() -> Result<String, String> {
...
#[tauri::command]
pub fn ensure_tessdata_first_run(app: tauri::AppHandle) -> Result<Vec<String>, String> {
...
#[tauri::command]
pub fn open_install_tools_wizard(app: tauri::AppHandle) -> Result<(), String> {
    let resource_root = app
        .path()
        .resource_dir()
        .map_err(|e| format!("resource_dir: {e}"))?;
...
#[tauri::command]
pub fn check_external_tools() -> Result<serde_json::Value, String> {
...
#[tauri::command]
pub fn check_msword() -> Result<ToolStatus, String> {
    #[cfg(target_os = "windows")]
    {
...
#[tauri::command]
pub async fn convert_via_msword(
    input_path: String,
    output_path: String,
) -> Result<(), String> {
    #[cfg(not(target_os = "windows"))]
...
#[tauri::command]
pub fn check_libreoffice() -> Result<ToolStatus, String> {
...
#[tauri::command]
pub fn check_tesseract() -> Result<ToolStatus, String> {
...
#[tauri::command]
pub async fn pdf_remove_password(
    input_path: String,
    output_path: String,
    password: String,
) -> Result<(), String> {
...
#[tauri::command]
pub async fn ocr_image_to_hocr(
    image_bytes: Vec<u8>,
    lang: String,
) -> Result<String, String> {
    use std::io::Write;
...
#[tauri::command]
pub async fn ocr_image_to_pdf_page(
    image_bytes: Vec<u8>,
    lang: String,
...
#[tauri::command]
pub async fn merge_pdf_pages_bytes(
    pages: Vec<Vec<u8>>,
    output_path: String,
) -> Result<(), String> {
    use lopdf::Document;
...
#[tauri::command]
pub async fn library_index_build(
    root: String,
    paths: Vec<String>,
...
#[tauri::command]
pub async fn library_search(query: String, limit: u32) -> Result<Vec<LibSearchHit>, String> {
...
#[tauri::command]
pub fn library_index_status() -> Result<bool, String> {
    let dir = library_index_dir()?;
    Ok(dir.join("meta.json").exists())
}

#[tauri::command]
pub fn library_index_clear() -> Result<(), String> {
    let dir = library_index_dir()?;
    if dir.exists() {
